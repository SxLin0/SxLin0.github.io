export const works = [
    { id: 'paoshen-novel', section: 'articles', title: '抛深历险记 · 已完结', href: 'novel/paoshen/', summary: '入山无路，灯下故人。一段从归寂院开始的历险。', tags: ['小说', '已完结'], featured: true, featuredOrder: 5 },
    {
    ...
    },
    {
        ...
        kind: 'html',
        source: 'content/articles-html/what-is-transformer.html',
        date: '2026',
